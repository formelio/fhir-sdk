...
impl From<r5::resources::StructureDefinitionDifferential> for ObjectField {
	fn from(differential: r5::resources::StructureDefinitionDifferential) -> Self {
...
fn type_to_string(r#type: r5::types::ElementDefinitionType) -> String {
...
pub fn parse_types(types: &str) -> Vec<Type> {
	let input = parse::read_definitions("r5", types);
